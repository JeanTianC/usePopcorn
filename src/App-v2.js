...
function Movie({movie,onSelectMovie}){
  return  <li className="" onClick={()=>onSelectMovie(movie.imdbID)} >
 ...
 useEffect(function(){
  ...
  return <div className="details">
    ...
    <section>
       ...
       <p>You rated with movie {watchedRating}
       <span>⭐</span>
       </p>
       }
      </div> 
...
function WatchedMoviesList({watched,onDeleteWatched}){
  ...
  {watched.map((movie) => (
   <WatchedMovies movie={movie} onDeleteWatched={onDeleteWatched} />
  ))}
</ul>
}
